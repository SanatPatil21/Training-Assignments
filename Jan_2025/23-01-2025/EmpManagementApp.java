...
//23-01-2025: Update the whole code to now include persistentness
// So we need to save all employee details in employees.csv and store and read from that only.
import java.util.*;
    ...
    public static Map<Integer, Employee> readFromCSV() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("employees.csv"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                // Create an array of strings with the size equal to the number of tokens in the line
...
public class EmpManagementApp {
    ...
    public static void main(String args[]) throws InputMismatchException {
        ...
        employees = CSVReader.readFromCSV();
        try {
            do {
                System.out.println("-------------------------------------");
